...
<tr valign="top">
	<th scope="row" class="titledesc">
		<label>
            <?php esc_html_e('PagBank', 'pagbank-for-woocommerce'); ?>
		</label>
	</th>
	<td class="forminp">
		<fieldset>
			...
			<button
				...
				data-pagbank-connect-environment-select="<?php echo esc_attr( $env_key ); ?>"
			...
			<p class="description">
                Conecte a sua conta PagBank para receber pagamentos como afiliado.
            </p>
		</fieldset>
	</td>
</tr>
